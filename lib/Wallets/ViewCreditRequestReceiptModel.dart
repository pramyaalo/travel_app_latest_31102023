class ViewCreditRequestReceiptModel {
  ...
  factory ViewCreditRequestReceiptModel.fromJson(Map<String, dynamic> json) {
    return ViewCreditRequestReceiptModel(
