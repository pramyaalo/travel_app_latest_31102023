class CreditRequestApprovedModel {
  String slNo;
  String userTypeId;
  String userId;
  ...
  factory CreditRequestApprovedModel.fromJson(Map<String, dynamic> json) {
    return CreditRequestApprovedModel(
