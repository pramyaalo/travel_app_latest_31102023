...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: DataCardRecharge(),
    );
  }
}

class DataCardRecharge extends StatefulWidget {
  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<DataCardRecharge> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'Enter DataCard Number',
                        ),
                      ),
                    ),
                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            'You can recharge your DataCard now. You can recharge from wallet balance.',
                          ),
                        ],
                      ),
                    ),
