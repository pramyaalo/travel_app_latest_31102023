...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: LandlineRecharge(),
    );
  }
}

class LandlineRecharge extends StatefulWidget {
  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<LandlineRecharge> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Please update the Landline details here..',
                      style: TextStyle(
                        fontSize: 16,
