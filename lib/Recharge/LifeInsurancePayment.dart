...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: LifeInsurancePayment(),
    );
  }
}

class LifeInsurancePayment extends StatefulWidget {
  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<LifeInsurancePayment> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Please update the Life Insurance details here..',
                      style: TextStyle(
                        fontSize: 16,
                  ...
                  Padding(
                      padding: const EdgeInsets.only(left: 10),
                      child: Text(
                        'Choose Your Life Insurance Operator:',
                        style: TextStyle(
                            fontSize: 16, fontWeight: FontWeight.w500),
                      )),
                  SizedBox(height: 10),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            'You can pay your Life Insurance now. You can recharge from wallet balance.',
                          ),
                        ],
                      ),
                    ),
