...
class _MyRechargePageState extends State<ElectricityPayment> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Please update the Electricity details here..',
                      style: TextStyle(
                        fontSize: 16,
                  ...
                  Padding(
                      padding: const EdgeInsets.only(left: 10),
                      child: Text(
                        'Choose Your Electricity Operator:',
                        style: TextStyle(
                            fontSize: 16, fontWeight: FontWeight.w500),
                      )),
                  SizedBox(height: 10),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            'You can pay your Electricity bill now. You can recharge from wallet balance.',
                          ),
                        ],
                      ),
                    ),
