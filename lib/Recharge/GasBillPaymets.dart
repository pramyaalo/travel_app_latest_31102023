...
class GasBillPaymets extends StatefulWidget {
  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<GasBillPaymets> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Please update the bill payment details here..',
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'Enter Subscriber ID/ Consumer ID:',
                        ),
                      ),
                    ),
                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            'You can pay your Gas bill Payment now. You can recharge from wallet balance.',
                          ),
                        ],
                      ),
                    ),
