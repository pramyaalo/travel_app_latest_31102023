...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: MobilePostpaidRecharge(),
    );
  }
}

class MobilePostpaidRecharge extends StatefulWidget {
  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<MobilePostpaidRecharge> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            'You can recharge your Postpaid now. You can recharge from wallet balance.',
                          ),
                        ],
                      ),
                    ),
