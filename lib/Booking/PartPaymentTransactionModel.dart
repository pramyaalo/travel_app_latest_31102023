class PartPaymentTransactionModel {
  ...
  factory PartPaymentTransactionModel.fromJson(Map<String, dynamic> json) {
    return PartPaymentTransactionModel(
