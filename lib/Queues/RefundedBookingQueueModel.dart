class RefundedBookingQueueModel {
  String slNo;
  String bookFlightId;
  String bookingId;
  String bookedOnDt;
  ...
  factory RefundedBookingQueueModel.fromJson(Map<String, dynamic> json) {
    return RefundedBookingQueueModel(
