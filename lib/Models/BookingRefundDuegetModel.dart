class BookingRefundDuegetModel {
  String slNo;
  String bookingId;
  ...
  factory BookingRefundDuegetModel.fromJson(Map<String, dynamic> json) {
    return BookingRefundDuegetModel(
