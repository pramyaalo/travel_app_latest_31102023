class CancelledFlightBookingModel {
  String slNo;
  String bookingId;
  ...
  factory CancelledFlightBookingModel.fromJson(Map<String, dynamic> json) {
    return CancelledFlightBookingModel(
