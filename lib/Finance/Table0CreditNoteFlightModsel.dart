class Table0CreditNoteFlightModsel {
  String bookFlightId;
  String bookingId;
  ...
  factory Table0CreditNoteFlightModsel.fromJson(Map<String, dynamic> json) {
    return Table0CreditNoteFlightModsel(
