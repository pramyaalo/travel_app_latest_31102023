...
class EditAssetEntry extends StatefulWidget {
  const EditAssetEntry({Key? key}) : super(key: key);

  @override
  State<EditAssetEntry> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<EditAssetEntry> {
