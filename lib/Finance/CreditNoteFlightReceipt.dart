                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  try {
                    ...
                    Table1CreditNoteFlightReceiptModel m1 =
                        Table1CreditNoteFlightReceiptModel.fromJson(table1[0]);
                    if (table1.isNotEmpty) {
                      for (int i = 0; i < table1.length; i++) {
                        ...
                        print(
                            'Index12: $i, Table4 bfgLength: ${table1.length}, t1Data: $t1Data');
                      }
                    }
                    tableData6.clear();
                    ...
                    if (table6.isNotEmpty) {
                      for (int i = 0; i < table6.length; i++) {
                        ...
                        print(
                            'Index234: $i, Table4deftt Length: ${table6.length}, t1Data: $t1Data');
                      }
                    }
                    tableData2.clear();
