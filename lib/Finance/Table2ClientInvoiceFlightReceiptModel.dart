class Table2ClientInvoiceFlightReceiptModel {
  String bftfPlightID;
  String type;
  String passenger;
  String tfpDOB;
  ...
  Table2ClientInvoiceFlightReceiptModel({
  ...
  factory Table2ClientInvoiceFlightReceiptModel.fromJson(
      Map<String, dynamic> json) {
    return Table2ClientInvoiceFlightReceiptModel(
