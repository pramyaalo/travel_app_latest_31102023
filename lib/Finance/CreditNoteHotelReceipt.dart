...
class _BookingCardGeneralDetailsState extends State<CreditNoteHotelReceipt> {
  ...
  List<Table7CreditNotelHotelReceiptModel> tableData7 = [];
              ...
              child: FutureBuilder<String?>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.connectionState == ConnectionState.done) {
                      try {
                        tableData9.clear();
                        Table9CreditNoteHoteleceipt m9 =
                            Table9CreditNoteHoteleceipt.fromJson(table9[0]);
                        if (table9.isNotEmpty) {
                          for (int i = 0; i < table9.length; i++) {
                            Table9CreditNoteHoteleceipt t1Data =
                                Table9CreditNoteHoteleceipt.fromJson(table9[i]);
                        ...
                        tableData7.clear();
                        Table7CreditNotelHotelReceiptModel m7 =
                            Table7CreditNotelHotelReceiptModel.fromJson(
                                table7[0]);
                        if (table7.isNotEmpty) {
                          for (int i = 0; i < table7.length; i++) {
                            Table7CreditNotelHotelReceiptModel t1Data =
                                Table7CreditNotelHotelReceiptModel.fromJson(
                                    table7[i]);
                        ...
                        tableData10.clear();
                        Table10CreditNoteHotelreceiptModel m10 =
                            Table10CreditNoteHotelreceiptModel.fromJson(
                                table10[0]);
                        if (table10.isNotEmpty) {
                          for (int i = 0; i < table10.length; i++) {
                            Table10CreditNoteHotelreceiptModel t1Data =
                                Table10CreditNoteHotelreceiptModel.fromJson(
                                    table10[i]);
                        ...
                        Table11CreditNoteHotelreceiptModel m11 =
                            Table11CreditNoteHotelreceiptModel.fromJson(
                                table11[0]);
                        if (table11.isNotEmpty) {
                          m11 = Table11CreditNoteHotelreceiptModel.fromJson(
                              table11[0]);
                        ...
                        Table48CreditNoteHolidayModel m48 =
                            Table48CreditNoteHolidayModel.fromJson(table48[0]);
                        if (table48.isNotEmpty) {
                          m48 = Table48CreditNoteHolidayModel.fromJson(
                              table48[0]);
                        ...
                        CreditNoteHolidayTaxModel m49 =
                            CreditNoteHolidayTaxModel.fromJson(table49[0]);
                        if (table49.isNotEmpty) {
                          m49 = CreditNoteHolidayTaxModel.fromJson(table49[0]);
