class Table20InvoiceHolidayReceiptModel {
  String bookFlightId;
  String hotelName;
  String starCategory;
  String hotelAddress;
  ...
  Table20InvoiceHolidayReceiptModel({
  ...
  factory Table20InvoiceHolidayReceiptModel.fromJson(
      Map<String, dynamic> json) {
    return Table20InvoiceHolidayReceiptModel(
