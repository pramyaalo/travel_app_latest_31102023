                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  try {
                    ...
                    Table20InvoiceHolidayReceiptModel m20 =
                        Table20InvoiceHolidayReceiptModel.fromJson(table20[0]);
                    if (table20.isNotEmpty) {
                      for (int i = 0; i < table20.length; i++) {
                        ...
                        print(
                            'Indexsd: $i, Tablert4 Length: ${table20.length}, t1Data: $t1Data');
                      }
                    }
                    tableData22.clear();
                    ...
                    if (table22.isNotEmpty) {
                      for (int i = 0; i < table22.length; i++) {
                        ...
                        print(
                            'Inde6tx: $i, Table64 Length: ${table22.length}, t1Data: $t1Data');
                      }
                    }
