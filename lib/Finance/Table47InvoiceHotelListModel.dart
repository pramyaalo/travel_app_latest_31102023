class Table47InvoiceHotelListModel {
  ...
  factory Table47InvoiceHotelListModel.fromJson(Map<String, dynamic> json) {
    return Table47InvoiceHotelListModel(
