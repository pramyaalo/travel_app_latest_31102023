class Table2CreditNoteFlightreceiptModel {
  String bftfpLightID;
  String type;
  String passenger;
  String tfpDOB;
  ...
  Table2CreditNoteFlightreceiptModel({
  ...
  factory Table2CreditNoteFlightreceiptModel.fromJson(
      Map<String, dynamic> json) {
    return Table2CreditNoteFlightreceiptModel(
