class Table7CreditNotelHotelReceiptModel {
  ...
  Table7CreditNotelHotelReceiptModel({
  ...
  factory Table7CreditNotelHotelReceiptModel.fromJson(
      Map<String, dynamic> json) {
    return Table7CreditNotelHotelReceiptModel(
