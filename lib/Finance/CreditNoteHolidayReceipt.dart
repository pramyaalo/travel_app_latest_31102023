...
class _BookingCardGeneralDetailsState extends State<CreditNoteHolidayReceipt> {
  ...
  List<Table22CrediutNoteHolidayReceiptModel> tableData22 = [];
  List<Table20CreditNoteHolidayListModel> tableData20 = [];
              ...
              child: FutureBuilder<String?>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.connectionState == ConnectionState.done) {
                      try {
                        tableData20.clear();
                        Table20CreditNoteHolidayListModel m20 =
                            Table20CreditNoteHolidayListModel.fromJson(
                                table20[0]);
                        if (table20.isNotEmpty) {
                          for (int i = 0; i < table20.length; i++) {
                            Table20CreditNoteHolidayListModel t1Data =
                                Table20CreditNoteHolidayListModel.fromJson(
                                    table20[i]);
                        ...
                        tableData22.clear();
                        Table22CrediutNoteHolidayReceiptModel m22 =
                            Table22CrediutNoteHolidayReceiptModel.fromJson(
                                table22[0]);
                        if (table22.isNotEmpty) {
                          for (int i = 0; i < table22.length; i++) {
                            Table22CrediutNoteHolidayReceiptModel t1Data =
                                Table22CrediutNoteHolidayReceiptModel.fromJson(
                                    table22[i]);
