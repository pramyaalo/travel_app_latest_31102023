class Table7InvoiceListHotelModel {
  ...
  factory Table7InvoiceListHotelModel.fromJson(Map<String, dynamic> json) {
    return Table7InvoiceListHotelModel(
